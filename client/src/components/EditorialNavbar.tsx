    ...
    <header className="sticky top-0 z-40 border-b border-[#e8eaed] dark:border-[#1e232e] bg-[#fafcfe]/95 dark:bg-[#090a0d]/95 backdrop-blur-xs transition-colors">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav
          ...
          className="hidden md:flex items-center gap-1 rounded-full bg-black/[0.03] dark:bg-white/[0.04] p-1 border border-black/[0.04] dark:border-white/[0.06]"
        >
        ...
        <div className="flex items-center gap-3">
          ...
          {isStaff ? (
            <div className="hidden sm:flex items-center gap-2">
              <Link
                href="/manage"
                className="inline-flex items-center gap-1.5 rounded-full border border-neutral-200 dark:border-neutral-800 bg-neutral-100 dark:bg-neutral-900 px-3 py-1.5 text-xs font-bold text-neutral-800 dark:text-neutral-200 transition hover:bg-neutral-200 dark:hover:bg-neutral-800"
              >
              ...
              {isAdmin ? (
                <Link
                  href="/admin"
                  className="inline-flex items-center rounded-full px-3 py-1.5 text-xs font-semibold text-neutral-600 dark:text-neutral-400 hover:text-black dark:hover:text-white"
                >
                  Analytics
                </Link>
              ) : null}
            ...
            <div className="hidden sm:flex items-center gap-3">
              <Link
                href="/staff/login"
                className="inline-flex items-center gap-1 text-xs font-semibold text-[#71717a] dark:text-[#a1a1aa] hover:text-[#0a0a0a] dark:hover:text-white"
              >
